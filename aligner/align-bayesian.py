...
def main(argv):
	...
	bitext    = loadData()
	alignment = pretrain( bitext )
	train( bitext, alignment )
	pass
...
def pretrain( bitext ):
	"""
	Use EM algorithm to pretrain alignment

	And use the output of EM algorithm as the input of initial alignment
	"""
	sys.stderr.write("Start Pre-Training...\n")
	f_list   = []
	e_list   = []
	...
	# use a dictionary to save alignment
	alignment = {}
...
def train( bitext, alignment ):
	...
	# Posterior of alignment given E,F,prior alignment
	prob_posterior = {}
...
def gibbs( prob, alignment):
	# Gibbs Sampling alignment 
